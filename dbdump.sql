...
CREATE TABLE `debug` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=13009 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `debug` VALUES (12908,'action = r'),(12909,'{\"ref_id\":\"18\",\"type\":\"2\",\"title\":\"Survey of Energy Resources\",\"author\":\"Attanasi, Emil D.; Meyer, Richard F\",\"publisher\":\"World Energy Council\",\"url\":\"http://www.worldenergy.org/documents/ser_2010_report_1.pdf\",\"date\":\"2010\",\"isbn\":\"0-946121-26-5\",\"location\":\"London\",\"page\":\"123 - 140\",\"volume\":null,\"number\":null,\"issue_id\":\"12\"}'),(12910,'action = i'),(12911,'INSERT refs SET type = \'4\', title = \'Alberta\\\'s Oil Sands: Opportunity, Balance\', publisher = \'Government of Alberta\', url = \'http://www.environment.alberta.ca/documents/Oil_Sands_Opportunity_Balance.pdf\', date = \'March 2008\', isbn = \'0-946121-26-5\', location = \'London\', issue_id = \'12\''),(12912,'action = r'),(12913,'{\"ref_id\":\"18\",\"type\":\"2\",\"title\":\"Survey of Energy Resources\",\"author\":\"Attanasi, Emil D.; Meyer, Richard F\",\"publisher\":\"World Energy Council\",\"url\":\"http://www.worldenergy.org/documents/ser_2010_report_1.pdf\",\"date\":\"2010\",\"isbn\":\"0-946121-26-5\",\"location\":\"London\",\"page\":\"123 - 140\",\"volume\":null,\"number\":null,\"issue_id\":\"12\"}'),(12914,'action = r'),(12915,'action = r'),(12916,'action = r'),(12917,'{\"ref_id\":\"18\",\"type\":\"2\",\"title\":\"Survey of Energy Resources\",\"author\":\"Attanasi, Emil D.; Meyer, Richard F\",\"publisher\":\"World Energy Council\",\"url\":\"http://www.worldenergy.org/documents/ser_2010_report_1.pdf\",\"date\":\"2010\",\"isbn\":\"0-946121-26-5\",\"location\":\"London\",\"page\":\"123 - 140\",\"volume\":null,\"number\":null,\"issue_id\":\"12\"}'),(12918,'action = r'),(12919,'action = r'),(12920,'action = r'),(12921,'action = r'),(12922,'action = r'),(12923,'{\"ref_id\":\"18\",\"type\":\"2\",\"title\":\"Survey of Energy Resources\",\"author\":\"Attanasi, Emil D.; Meyer, Richard F\",\"publisher\":\"World Energy Council\",\"url\":\"http://www.worldenergy.org/documents/ser_2010_report_1.pdf\",\"date\":\"2010\",\"isbn\":\"0-946121-26-5\",\"location\":\"London\",\"page\":\"123 - 140\",\"volume\":null,\"number\":null,\"issue_id\":\"12\"}'),(12924,'action = r'),(12925,'action = r'),(12926,'{\"ref_id\":\"18\",\"type\":\"2\",\"title\":\"Survey of Energy Resources\",\"author\":\"Attanasi, Emil D.; Meyer, Richard F\",\"publisher\":\"World Energy Council\",\"url\":\"http://www.worldenergy.org/documents/ser_2010_report_1.pdf\",\"date\":\"2010\",\"isbn\":\"0-946121-26-5\",\"location\":\"London\",\"page\":\"123 - 140\",\"volume\":null,\"number\":null,\"issue_id\":\"12\"}'),(12927,'action = r'),(12928,'action = r'),(12929,'action = r'),(12930,'action = r'),(12931,'action = r'),(12932,'action = r'),(12933,'action = r'),(12934,'action = r'),(12935,'{\"ref_id\":\"18\",\"type\":\"2\",\"title\":\"Survey of Energy Resources\",\"author\":\"Attanasi, Emil D.; Meyer, Richard F\",\"publisher\":\"World Energy Council\",\"url\":\"http://www.worldenergy.org/documents/ser_2010_report_1.pdf\",\"date\":\"2010\",\"isbn\":\"0-946121-26-5\",\"location\":\"London\",\"page\":\"123 - 140\",\"volume\":null,\"number\":null,\"issue_id\":\"12\"}'),(12936,'action = r'),(12937,'{\"ref_id\":\"1\",\"type\":\"1\",\"title\":\"Global warming\",\"author\":\"Wikipedia contributors\",\"publisher\":\"Wikipedia, the Free Encyclopedia\",\"url\":\"http://en.wikipedia.org/wiki/Global_warming\",\"date\":\"19 January 2013\",\"isbn\":\"\",\"location\":\"\",\"page\":\"\",\"volume\":\"\",\"number\":\"\",\"issue_id\":\"9\"}'),(12938,'action = r'),(12939,'action = r'),(12940,'action = r'),(12941,'{\"ref_id\":\"3\",\"type\":\"3\",\"title\":\"Midwest to feel the heat of global warming\",\"author\":\"Berwyn, Bob\",\"publisher\":\"Summit County Citizens Voice\",\"url\":\"http://summitcountyvoice.com/2013/01/19/midwest-to-feel-the-heat-of-global-warming/\",\"date\":\"19 January 2013\",\"isbn\":\"\",\"location\":\"\",\"page\":\"\",\"volume\":\"\",\"number\":\"\",\"issue_id\":\"9\"}'),(12942,'action = r'),(12943,'action = r'),(12944,'action = r'),(12945,'action = r'),(12946,'action = r'),(12947,'action = r'),(12948,'action = r'),(12949,'{\"ref_id\":\"3\",\"type\":\"3\",\"title\":\"Midwest to feel the heat of global warming\",\"author\":\"Berwyn, Bob\",\"publisher\":\"Summit County Citizens Voice\",\"url\":\"http://summitcountyvoice.com/2013/01/19/midwest-to-feel-the-heat-of-global-warming/\",\"date\":\"19 January 2013\",\"isbn\":\"\",\"location\":\"\",\"page\":\"\",\"volume\":\"\",\"number\":\"\",\"issue_id\":\"9\"}'),(12950,'action = r'),(12951,'{\"ref_id\":\"4\",\"type\":\"4\",\"title\":\"Robust responses of the hydrological cycle to global warming\",\"author\":\"Held, Isaac M., and Brian J. Soden\",\"publisher\":\"Journal of Climate\",\"url\":\"http://journals.ametsoc.org/doi/pdf/10.1175/JCLI3990.1\",\"date\":\"2006\",\"isbn\":\"\",\"location\":\"\",\"page\":\"5686 - 5699\",\"volume\":\"19\",\"number\":\"21\",\"issue_id\":\"9\"}'),(12952,'action = r'),(12953,'{\"ref_id\":\"1\",\"type\":\"1\",\"title\":\"Global warming\",\"author\":\"Wikipedia contributors\",\"publisher\":\"Wikipedia, the Free Encyclopedia\",\"url\":\"http://en.wikipedia.org/wiki/Global_warming\",\"date\":\"19 January 2013\",\"isbn\":\"\",\"location\":\"\",\"page\":\"\",\"volume\":\"\",\"number\":\"\",\"issue_id\":\"9\"}'),(12954,'action = u'),(12955,'UPDATE refs SET type = \'1\', title = \'Global warminggjjgjhgj\', author = \'Wikipedia contributors\', publisher = \'Wikipedia, the Free Encyclopedia\', url = \'http://en.wikipedia.org/wiki/Global_warming\', date = \'19 January 2013\', issue_id = \'9\' WHERE ref_id = \'1\''),(12956,'{\"ref_id\":\"1\",\"type\":\"1\",\"title\":\"Global warminggjjgjhgj\",\"author\":\"Wikipedia contributors\",\"publisher\":\"Wikipedia, the Free Encyclopedia\",\"url\":\"http://en.wikipedia.org/wiki/Global_warming\",\"date\":\"19 January 2013\",\"isbn\":\"\",\"location\":\"\",\"page\":\"\",\"volume\":\"\",\"number\":\"\",\"issue_id\":\"9\"}'),(12957,'action = u'),(12958,'UPDATE refs SET type = \'1\', title = \'Global warming\', author = \'Wikipedia contributors\', publisher = \'Wikipedia, the Free Encyclopedia\', url = \'http://en.wikipedia.org/wiki/Global_warming\', date = \'19 January 2013\', issue_id = \'9\' WHERE ref_id = \'1\''),(12959,'{\"ref_id\":\"1\",\"type\":\"1\",\"title\":\"Global warming\",\"author\":\"Wikipedia contributors\",\"publisher\":\"Wikipedia, the Free Encyclopedia\",\"url\":\"http://en.wikipedia.org/wiki/Global_warming\",\"date\":\"19 January 2013\",\"isbn\":\"\",\"location\":\"\",\"page\":\"\",\"volume\":\"\",\"number\":\"\",\"issue_id\":\"9\"}'),(12960,'action = u'),(12961,'UPDATE refs SET type = \'1\', title = \'Global warming\', author = \'Wikipedia contributors\', publisher = \'Wikipedia, the Free Encyclopedia\', url = \'http://en.wikipedia.org/wiki/Global_warming\', date = \'19 January 2013\', issue_id = \'9\' WHERE ref_id = \'1\''),(12962,'{\"ref_id\":\"1\",\"type\":\"1\",\"title\":\"Global warming\",\"author\":\"Wikipedia contributors\",\"publisher\":\"Wikipedia, the Free Encyclopedia\",\"url\":\"http://en.wikipedia.org/wiki/Global_warming\",\"date\":\"19 January 2013\",\"isbn\":\"\",\"location\":\"\",\"page\":\"\",\"volume\":\"\",\"number\":\"\",\"issue_id\":\"9\"}'),(12963,'action = r'),(12964,'action = r'),(12965,'action = r'),(12966,'action = r'),(12967,'action = r'),(12968,'action = r'),(12969,'action = r'),(12970,'{\"ref_id\":\"1\",\"type\":\"1\",\"title\":\"Global warming\",\"author\":\"Wikipedia contributors\",\"publisher\":\"Wikipedia, the Free Encyclopedia\",\"url\":\"http://en.wikipedia.org/wiki/Global_warming\",\"date\":\"19 January 2013\",\"isbn\":\"\",\"location\":\"\",\"page\":\"\",\"volume\":\"\",\"number\":\"\",\"issue_id\":\"9\"}'),(12971,'action = r'),(12972,'action = r'),(12973,'action = r'),(12974,'action = r'),(12975,'action = r'),(12976,'{\"ref_id\":\"1\",\"type\":\"1\",\"title\":\"Global warming\",\"author\":\"Wikipedia contributors\",\"publisher\":\"Wikipedia, the Free Encyclopedia\",\"url\":\"http://en.wikipedia.org/wiki/Global_warming\",\"date\":\"19 January 2013\",\"isbn\":\"\",\"location\":\"\",\"page\":\"\",\"volume\":\"\",\"number\":\"\",\"issue_id\":\"9\"}'),(12977,'action = r'),(12978,'action = r'),(12979,'Citizen ID = {$citizen_id}'),(12980,'Citizen ID = 1'),(12981,'Citizen ID = 1'),(12982,'Citizen ID = 1'),(12983,'Citizen ID = 1'),(12984,'Citizen ID = 1'),(12985,'Citizen ID = 1'),(12986,'Citizen ID = 1'),(12987,'Citizen ID = 1'),(12988,'Citizen ID = 1'),(12989,'Citizen ID = 1'),(12990,'Citizen ID = 1'),(12991,'Citizen ID = 1'),(12992,'Citizen ID = 1'),(12993,'Citizen ID = 1'),(12994,'Citizen ID = 1'),(12995,'Citizen ID = 1'),(12996,'Citizen ID = 1'),(12997,'Citizen ID = 1'),(12998,'Citizen ID = 1'),(12999,'Citizen ID = 1'),(13000,'Citizen ID = 1'),(13001,'Citizen ID = 1'),(13002,'Citizen ID = 1'),(13003,'Citizen ID = 1'),(13004,'Citizen ID = 1'),(13005,'Citizen ID = 1'),(13006,'Citizen ID = 1'),(13007,'Citizen ID = 1'),(13008,'Citizen ID = 1');
...
INSERT INTO `position_citizen` VALUES (1,1,1),(2,1,2),(3,1,1),(4,1,1),(6,1,1),(7,1,2),(10,1,1),(1,3,2),(1,2,1),(13,1,1),(15,1,2),(1,4,2),(1,5,1);
...
-- Dump completed on 2013-01-31  6:46:07
